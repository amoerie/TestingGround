...
{
    [TestFixture]
    public class TestsForEagerCollectionLoading: TestBase
    {
        private readonly IEntityLoader<GymMember> _workoutsLoader = EntityLoader<GymMember>.Include(g => g.Workouts);
