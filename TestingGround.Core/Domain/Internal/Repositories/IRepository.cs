...
namespace TestingGround.Core.Domain.Internal.Repositories
{
        ...
        where TEntity : class, IDeletable, IIdentifiable
    {
        ...
        /// 
        /// <param name="query">
        ///     The query that specifies what to do with the <see cref="EntitySet"/> of <typeparamref name="TEntity"/>
        /// </param>
        /// 
        /// <typeparam name="TResult">
        ...
        /// </returns>
        TResult Query<TResult>(Expression<Func<IQueryable<TEntity>, TResult>> query);
